...
[_MALT] = { /* Malt Layout, customised for reduced columns (ex: quote and shift locations) */
  ...
  {XXXXXXX, M(VOLD), SHIFT,   KC_LSFT, KC_BSPC,        KC_SPC,  FNKEY,  KC_ENT,   KC_TAB,  XXXXXXX }
},
...
[_FUNCTION] = { /* Function Layer, primary alternative layer featuring numpad on right hand,
  ...
  {XXXXXXX, _______, _______,  _______,  _______,    _______, _______,  KC_HOME, KC_PGUP, XXXXXXX },
  {XXXXXXX, _______, _______,  _______,  KC_DELETE,  _______, _______,  KC_END,  KC_PGDN, XXXXXXX }
},
